      ...
      <main className="mx-auto flex w-full max-w-lg flex-1 flex-col justify-center px-4 py-12">
        <div className="rounded-2xl border border-emerald-200 bg-white p-8 text-center shadow-sm">
            ...
            <div className="mt-6 rounded-lg bg-slate-50 px-4 py-3 text-left text-sm">
              ...
              {state.orderId && (
                <p className="mt-1 text-slate-500">
                  Mã tham chiếu: <span className="font-mono text-slate-700">{state.orderId}</span>
                </p>
              )}
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:justify-center">
            ...
            <Link
              to="/"
              className="inline-flex justify-center rounded-lg border border-slate-200 px-6 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50"
            >
              Về trang chủ
            </Link>
          </div>
